<script>
    ...
    const meta = {
        ...
        parameters: {
            docs: {
                description: {
                    component: 'For styling blocks of text in an article-like format',
                },
            },
        },
        argTypes: {
            center: {
                ...
                name: 'center',
                description: 'Centers the text, equivalent to using `mx-auto`',
...
<Template let:args>
    <TextContent {...args}>
        ...
        <p>
            ...
            because you spend less time undoing user-agent styles, but when you
            <em>really are</em> just trying to style some content that came from a rich-text editor in
        ...
        <p>
            ...
            the user-agent styles either — you want them to look <em>awesome</em>, not awful.
        </p>
        <p>
...
&lt;/article&gt;
        ...
        <ul>
            <li>
                ...
                <p>
                    ...
                    list items to all make sense. Pretty tough honestly, you could make a strong
        ...
        <p>
            ...
            code blocks but it wouldn't hurt to make them look
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <p>
                            As you can see here, because I've added a second line, this list item
                            now has a <code>&lt;p&gt;</code> tag.
                        </p>
        ...
        <p>
            ...
            look good. This <em>"wrap the code blocks in backticks"</em> trick works pretty well though
            really.
        </p>
        <p>
